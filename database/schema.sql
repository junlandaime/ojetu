...
--
-- Table structure for table `program_payment_plans`
--
...
INSERT INTO `users` (`id`, `email`, `password`, `full_name`, `phone`, `address`, `profile_picture`, `user_type`, `created_at`, `updated_at`, `birth_place`, `birth_date`, `is_verified`, `verification_token_sent_at`, `allow_multiple_programs`, `last_login_at`) VALUES
(1, 'admin@gmail.com', '$2a$12$xJy3WDCbb37u0BCUepQTk.QL7A7B8hrka0.ZH6gh1NwN3PljrMufG', 'Admin Fitalenta', '081312557168', '', NULL, 'admin', '2025-10-02 07:08:29', '2025-10-21 12:19:54', NULL, NULL, 1, NULL, 1, NULL),
(5, 'user1@gmail.com', '$2b$12$tEe5PStStL4/aqC56ZSIX.ytdeaGPveMAOGxO3BC.Df45ZjEoag2a', 'User 1', '', '', NULL, 'participant', '2025-10-21 12:21:55', '2025-10-21 12:21:55', NULL, NULL, 1, NULL, 0, NULL),
(6, 'user2@gmail.com', '$2b$12$Im8LbTmbb4mYZaaeZCwqY.e00xuELRmGH01eSJkd2kcLccFWnh/t6', 'User 2', '', '', NULL, 'participant', '2025-10-21 12:22:54', '2025-10-21 12:22:54', NULL, NULL, 0, NULL, 0, NULL);
...
--
ALTER TABLE `success_stories`
  ADD CONSTRAINT `success_stories_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `success_stories_ibfk_2` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
