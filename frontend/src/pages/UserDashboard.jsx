              ...
              {registrations.length > 0 ? (
                ...
                <div className="text-center py-5">
                  ...
                  <p className="text-muted mb-4">
                    Anda belum terdaftar dalam program Pelatihan dan Penyaluran Tenaga Kerja Fitalenta.
                  </p>
                  <Link to="/registration" className="btn btn-primary">
                    Daftar Program Pelatihan dan Penyaluran Tenaga Kerja Fitalenta
                  </Link>
                </div>
              )}
            </div>
...
=======
    ...
    const getStatusBadge = (status) => {
        const statusConfig = {
            ...
            registration_menunggu: {
                class: "warning",
                text: "Menunggu Interview",
            },
            registration_lolos: {
                class: "success",
                text: "Lolos Interview",
            },
            registration_tidak_lolos: {
                class: "danger",
                text: "Tidak Lolos Interview",
    ...
    const getCardStatusData = (registrations) => {
        ...
        const getPaymentStatusClass = (paymentStatus) => {
            ...
            if (
                paymentStatus &&
                paymentStatus.startsWith("installment_")
            ) {
                return "info";
            }
        ...
        const getPaymentStatusText = (paymentStatus) => {
            if (paymentStatus === "paid") return "Lunas";
            if (paymentStatus === "installment_1") {
                return "Cicilan 1";
            }
            if (paymentStatus === "installment_2") {
                return "Cicilan 2";
            }
            if (paymentStatus === "installment_3") {
                return "Cicilan 3";
            }
            if (paymentStatus === "installment_4") {
                return "Cicilan 4";
            }
            if (paymentStatus === "installment_5") {
                return "Cicilan 5";
            }
            if (paymentStatus === "installment_6") {
                return "Cicilan 6";
            }
            if (paymentStatus === "overdue") {
                return "Jatuh Tempo";
        ...
        return {
            ...
            selectionStatus: {
                status:
                    latestRegistration.selection_status || "-",
                class:
                    latestRegistration.selection_status === "lolos"
                        ? "success"
                        : latestRegistration.selection_status ===
            ...
            placementStatus: {
                status:
                    latestRegistration.placement_status || "-",
                class:
                    latestRegistration.placement_status ===
                    "ditempatkan"
                        ? "success"
            ...
            programName:
                latestRegistration.program_name || "-",
            companyName:
                latestRegistration.company_name || "-",
        };
    };
    ...
    const cardData =
        getCardStatusData(registrations);
    /* =========================
       MAIN DASHBOARD
    ========================= */
    return (
                ...
                <div className="dashboard-container">
                    ...
                    {registrations.length > 0 && (
                        <div className="dashboard-information">
                            <div className="alert alert-info">
                                ...
                                <ul className="mb-0">
                                    <li>
                                        Status akan diperbarui secara real-time oleh admin
                                    </li>
                                    <li>
                                        Untuk pertanyaan mengenai status, hubungi admin
                                    </li>
                                    <li>
                                        Proses interview membutuhkan waktu 3-5 hari kerja
                                    </li>
                                    <li>
                    ...
                    <div className="program-detail-card">
                        ...
                        <div className="program-detail-header">
                            <h4 className="program-detail-title">
                                Detail Program Anda
                            </h4>
                        </div>
                        ...
                        <div className="program-detail-body">
                            ...
                            {registrations.length > 0 ? (
                                ...
                                <div className="program-empty">
                                    ...
                                    <h5 className="program-empty-title">
                                        Data tidak tersedia
                                    </h5>

                                    <p className="program-empty-text">
